...
namespace ddml {
  ...
  void FCCeeCLDGeometry::prepareInput(G4FastTrack const& aFastTrack,
...
void FCCeeCLDGeometry::convertOutput(G4FastTrack const& aFastTrack,
            G4ThreeVector const& localDir,
    ...
    std::cout << "FCCeeCLDGeometry::convertOutput - check_rot = " << check_rot << std::endl;
