...
void RegularGridGANModel::prepareInput(G4FastTrack const& aFastTrack, G4ThreeVector const&, InputVecs& inputs,
  ...
  dd4hep::printout(dd4hep::DEBUG, "RegularGridGANModel::prepareInput",
                   "pos0 = (%f, %f, %f) - dir = (%f, %f, %f) - E = %f", position.x(), position.y(), position.z(),
                   direction.x(), direction.y(), direction.z(), energy / CLHEP::GeV);
