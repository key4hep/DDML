...
#SIM.inputFiles = '/beegfs/desy/user/mckeownp/DDML/Angle_version_with_triggers/ddfastshowerml/Tau_pi0_gen_files/gen_tau_pi0_250-SetA_2f_leptonic_eL_pR.slcio' #[]
SIM.inputFiles = '/beegfs/desy/user/mckeownp/DDML/Angle_version_with_triggers/ddfastshowerml/Tau_pi0_gen_files/gen_tau_pi0_twophotons_trigger_250-SetA_2f_leptonic_eL_pR_file_61.slcio' 
...
#SIM.outputFile = '/beegfs/desy/user/mckeownp/DDML/Angle_version_with_triggers/ddfastshowerml/Tau_pi0_G4_files/G4_tau_pi0_250-SetA_2f_leptonic_eL_pR.slcio' #"dummyOutput.slcio"

### Original seed path
#SIM.outputFile = '/beegfs/desy/user/mckeownp/DDML/Angle_version_with_triggers/ddfastshowerml/Tau_pi0_G4_files/G4_tau_pi0_twophotons_trigger_250-SetA_2f_leptonic_eL_pR_file_61.slcio'

#### Second seed path
#SIM.outputFile = '/beegfs/desy/user/mckeownp/DDML/Angle_version_with_triggers/ddfastshowerml/Tau_pi0_G4_files/G4_tau_pi0_twophotons_trigger_250-SetA_2f_leptonic_eL_pR_file_61_SEED_2.slcio'

#### Third seed path
SIM.outputFile = '/beegfs/desy/user/mckeownp/DDML/Angle_version_with_triggers/ddfastshowerml/Tau_pi0_G4_files/G4_tau_pi0_twophotons_trigger_250-SetA_2f_leptonic_eL_pR_file_61_SEED_3.slcio'
