...
SIM.outputFile = "/beegfs/desy/user/mckeownp/DDML/Angle_version_with_triggers/ddfastshowerml/Single_photon_timing_G4/Single_photon_timing_check_G4_5GeV.slcio"
