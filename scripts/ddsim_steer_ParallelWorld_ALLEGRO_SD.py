...
SIM.macroFile = "./singleEmMesh_gps_Optimise_ALLEGRO.mac"
...
SIM.physics.list = "FTFP_BERT" #"QGSP_BERT"  # "FTFP_BERT"
...
def LoadHdf5(kernel):
    ...
    if BIBAE == True and Two_Angle == True:
        ...
        ml_file = "../models/ddsim_mesh_FCCeeCLD_gamma_1000events_50GeV_phi0p0_theta1p57_edm4hep_9292534p0.h5"
        # ml_file = "../models/model.torchscriptcaliDiTcinyufinal.pt"
        # ml_file = "../models/BIBAE_Two_Angle_Full_PP_cut.pt"
