...
/** Class for running the ML model from Geant4 - Par04 example for fast shower simulation.
 *  Assumes a cylindrical geometry with (rho, phi) defining the calorimeter planes and z 
