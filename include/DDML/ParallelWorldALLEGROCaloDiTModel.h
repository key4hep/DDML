#ifndef ParallelWorldALLEGROCaloDiTModel_H
#define ParallelWorldALLEGROCaloDiTModel_H
 ...
 *
 * 
 * CaloDiT parallel world model for the allegro detector
 * @author P. McKeown, CERN
 * @date March. 2025
 */

class ParallelWorldALLEGROCaloDiTModel : public ModelInterface {
public:
  ParallelWorldALLEGROCaloDiTModel(){};

  virtual ~ParallelWorldALLEGROCaloDiTModel(){};
...
private:
  ...
  double _cellSizeRho = 5 * CLHEP::mm; // mm
  double _cellSizeZ = 11 * CLHEP::mm;    // mm
